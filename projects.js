...
// ===================================================================================
// This file exports a single `portfolioData` object, making it easy to import
// and use your portfolio information throughout an application.
// ===================================================================================
...
const portfolioData = {
  ...
  // A unified array of all projects, including both designs and services.
  // Each project has a 'type' property ('design' or 'service') for easy filtering.
  projects: [
    {
      id: 'leafinity',
      type: 'design',
...
// Use 'export default' to make this object available for other files to import.
// For example: import myPortfolio from './database.js';
